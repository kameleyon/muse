// Import the functions from jsonUtils.ts
import { safeJsonParse, convertToChartData, repairJson, deepRepairJson } from './jsonUtils.ts';

// Test function to log results
function testJsonParsing(label, input) {
  console.log(`\n--- Testing: ${label} ---`);
