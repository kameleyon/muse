...
import { 
  ...
  Smartphone, Monitor, Radio, Mail, Clock, Link
} from 'lucide-react';
...
export const settingsCategories: SettingsCategory[] = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'import-export', label: 'Import/Export Preferences', icon: <Workflow size={16} /> },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { id: 'learning', label: 'Learning and Development', icon: <BookOpen size={16} /> }
    ]
  },
  {
    id: 'mobile-platform',
